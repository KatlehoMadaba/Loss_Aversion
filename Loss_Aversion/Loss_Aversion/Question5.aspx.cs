...
namespace Loss_Aversion
{
    public partial class Question5 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            lblQuestions.Text = "The global economic situation is uncertain, impacting stock markets worldwide.";
        ...
        protected void btnAlosses_Click(object sender, EventArgs e)
        {
            ...
            Class1.UpdateDatabase(false, Session["SessionID"].ToString(), 5);
        ...
        protected void btnGains_Click(object sender, EventArgs e)
        {
            ...
            Class1.UpdateDatabase(true, Session["SessionID"].ToString(), 5);
