...
namespace Loss_Aversion
{
    public partial class Question6 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            lblQuestions.Text = "A promising tech company is going public, and you have the chance to invest in it.";
        ...
        protected void btnGains_Click(object sender, EventArgs e)
        {
            ...
            Class1.UpdateDatabase(true, Session["SessionID"].ToString(), 6);
